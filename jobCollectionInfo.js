...
html += "<div class='main'>\n<h1>Prospective WaterlooWorks Jobs Table</h1>"
html += "<table>\n<tr class='titles'>\n";
html += "<td><strong>CV</strong</td><td><strong>Position</strong></td>\n<td><strong>Company</stong></td>\n<td><strong>Location</strong></td>\n<td></td>\n<td></td>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n";
for(let i = 0; i < jobs[0].length; i++) {
  html += "<tr>\n";
  html += "<td><div class='check hidden'></div></td>\n";
  html += "<td>" + jobs[0][i] + "</td>\n";
  html += "<td>" + jobs[1][i] + "</td>\n";
  html += "<td>" + jobs[2][i] + "</td>\n";
  ...
  html += "<td><button class='undo hidden'>Undo</button></td>\n"
  html += "<td><button class='cover'>CoverLetter</button></td>\n"
  html += "</tr>\n"
}
html += "</table>\n</div>\n<div id='counters'>\n"
